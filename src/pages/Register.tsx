                ...
                <div className="h-[600px] w-[788px] flex border-2 border-gray-400 rounded-xl">
                    <section className="bg-gray-50 dark:bg-gray-900">
                        ...
                        <div className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                                <img className="w-24 h-8 mr-2 mt-2" src="src/img/logo.svg" alt="logo" />
                            </div>
                            <div className="w-full h-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                                <div className="p-6 space-y-2 md:space-y-2 sm:p-4">
                                    ...
                                    <form onSubmit={handleSubmit(handleData)} className="space-y-1 md:space-y-6">
                                    <div>
                                            <label className={label()} htmlFor="">Your Full Name</label>
                                            <input {...register("name")} className={input()} type="text" placeholder="Enter Your Full Name" />
                                        ...
                                        <button type="submit" className={search()}>Sign in</button>
                                        <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                            Don’t have an account yet? <span className="text-green-600 cursor-pointer text-sm">Register Now</span> 
                                        </p>
                                    </form>
                                </div>
                            </div>
