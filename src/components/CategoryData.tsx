            ...
            item?.map((product:any) =>{
                return (
                    ...
                    <div className='group relative'>
                                <div  key={item.id}   className=' mt-4 w-full h-24 cursor-pointer overflow-hidden'>
                                   <img className='w-full h-full object-contain group-hover:scale-110 duration-500' src={product.image} alt="" />
                                    {item.id}
                                </div>
